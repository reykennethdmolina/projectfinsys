!function (document, window, $) {
    ...
    $template_switcher.children('div').on('click',function (e) {
        ...
        if (pathArray == "dashboard_v1.html" || pathArray == "dashboard_v2.html" || pathArray == "dashboard_v3.html" || pathArray == "" || pathArray == "dashboard_left_menu.html" || pathArray == "dashboard_left_top.html" || pathArray == "base-layout.html") {
            jQuery('#site-color').attr({href: '/static/financial-layout/assets/css/colors/' + this_template + '.css'});
        } else {
            jQuery('#site-color').attr({href: '/static/financial-layout/assets/css/colors/' + this_template + '.css'});
        }
        ...
        if (porishtemplate !== null && porishtemplate !== "") {
            if (jQuery("#site-dark-color").length == 0) {
                if (pathArray == "dashboard_v1.html" || pathArray == "dashboard_v2.html" || pathArray == "dashboard_v3.html" || pathArray == "" || pathArray == "dashboard_left_menu.html" || pathArray == "dashboard_left_top.html" || pathArray == "base-layout.html") {
                    jQuery('#site-color').after('<link id="site-dark-color" rel="stylesheet" href="/static/financial-layout/assets/css/colors/dark/' + this_template + '-' + porishtemplate + '.css">');
                } else {
                    jQuery('#site-color').after('<link id="site-dark-color" rel="stylesheet" href="/static/financial-layout/assets/css/colors/dark/' + this_template + '-' + porishtemplate + '.css">');
                }
            } else {
                if (pathArray == "dashboard_v1.html" || pathArray == "dashboard_v2.html" || pathArray == "dashboard_v3.html" || pathArray == "" || pathArray == "dashboard_left_menu.html" || pathArray == "dashboard_left_top.html" || pathArray == "base-layout.html") {
                    jQuery('#site-dark-color').attr('href', '/static/financial-layout/assets/css/colors/dark/' + this_template + '-' + porishtemplate + '.css');
                } else {
                    jQuery('#site-dark-color').attr('href', '/static/financial-layout/assets/css/colors/dark/' + this_template + '-' + porishtemplate + '.css');
                }
            }
    ...
    else
    {
        if (pathArray == "dashboard_v1.html" || pathArray == "dashboard_v2.html" || pathArray == "dashboard_v3.html" || pathArray == "" || pathArray == "dashboard_left_menu.html" || pathArray == "dashboard_left_top.html") {
            jQuery('#site-color').attr({href: '/static/financial-layout/assets/css/colors/' + template_color + '.css'});
        } else {
            jQuery('#site-color').attr({href: '/static/financial-layout/assets/css/colors/' + template_color + '.css'});
        }
    ...
    $template_color.children('div').on('click',function (e) {
        ...
        if (this_template !== null && this_template !== "") {
            ...
            if (porishtemplate == null) {
                if (pathArray == "dashboard_v1.html" || pathArray == "dashboard_v2.html" || pathArray == "dashboard_v3.html" || pathArray == "" || pathArray == "dashboard_left_menu.html" || pathArray == "dashboard_left_top.html") {
                    jQuery('#site-color').after('<link id="site-dark-color" rel="stylesheet" href="/static/financial-layout/assets/css/colors/dark/' + template_color + '-' + this_template + '.css">');
                } else {
                    jQuery('#site-color').after('<link id="site-dark-color" rel="stylesheet" href="/static/financial-layout/assets/css/colors/dark/' + template_color + '-'  + this_template + '.css">');
                }
            } else if (jQuery("#site-dark-color").length == 0) {
                if (pathArray == "dashboard_v1.html" || pathArray == "dashboard_v2.html" || pathArray == "dashboard_v3.html" || pathArray == "" || pathArray == "dashboard_left_menu.html" || pathArray == "dashboard_left_top.html") {
                    jQuery('#site-color').after('<link id="site-dark-color" rel="stylesheet" href="/static/financial-layout/assets/css/colors/dark/' + porishtemplate + '-' + this_template + '.css">');
                } else {
                    jQuery('#site-color').after('<link id="site-dark-color" rel="stylesheet" href="/static/financial-layout/assets/css/colors/dark/' + porishtemplate + '-' + this_template + '.css">');
                }
            } else {
                if (pathArray == "dashboard_v1.html" || pathArray == "dashboard_v2.html" || pathArray == "dashboard_v3.html" || pathArray == "" || pathArray == "dashboard_left_menu.html" || pathArray == "dashboard_left_top.html") {
                    jQuery('#site-dark-color').attr('href', '/static/financial-layout/assets/css/colors/dark/' + porishtemplate + '-' + this_template + '.css');
                } else {
                    jQuery('#site-dark-color').attr('href', '/static/financial-layout/assets/css/colors/dark/' + porishtemplate + '-' + this_template + '.css');
                }
            }
