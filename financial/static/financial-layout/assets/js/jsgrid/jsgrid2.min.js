    ...
    "use strict",
     jsGrid.setDefaults({
        ...
        function() {
            ...
            }), $("#pagesortingField").on("change", function() {
                var field = $(this).val();
                $("#pageSorting").jsGrid("sort", field)
            })
        }(),
        function() {
            $("#pageCustomView").jsGrid({
                height: "500px",
                width: "100%",
                filtering: !0,
                editing: !0,
                ...
                var $cb = $(this);
                $("#pageCustomView").jsGrid("option", $cb.attr("value"), $cb.is(":checked"))
            })
        }(),
        function() {
            ...
            MyDateField.prototype = new jsGrid.Field({
                ...
                _createTextBox: function() {
                    return $("<input>").attr("type", "text").addClass("form-control input-md").datepicker({
                        autoclose: !0
                    })
                }
            }), jsGrid.fields.myDateField = MyDateField, $("#pageCustomGridField").jsGrid({
                height: "500px",
                width: "100%",
                inserting: !0,
                editing: !0,
