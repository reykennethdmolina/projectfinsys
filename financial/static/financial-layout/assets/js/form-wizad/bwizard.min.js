...
(function (f, h) {
    ...
    f.widget = function (o, d, p) {
        ...
        e.prototype = f.widget.extend(c, {widgetEventPrefix: o}, p, {constructor: e, namespace: n, widgetName: o, widgetBaseClass: a, widgetFullName: a});
        if (b) {
    ...
    f.Widget.prototype = {widgetName: "widget", widgetEventPrefix: "", defaultElement: "<div>", options: {disabled: false, create: null}, _createWidget: function (b, a) {
            ...
            this._on(a, {mouseenter: function (b) {
...
(function (a, b) {
    a.widget("bootstrap.bwizard", {options: {clickableSteps: true, autoPlay: false, delay: 3000, loop: false, hideOption: {fade: true}, showOption: {fade: true, duration: 400}, ajaxOptions: null, cache: false, cookie: null, stepHeaderTemplate: "", panelTemplate: "", spinner: "", backBtnText: "&larr; Previous", nextBtnText: "Next &rarr;", add: null, remove: null, activeIndexChanged: null, show: null, load: null, validating: null}, _defaults: {stepHeaderTemplate: "<li>#{title}</li>", panelTemplate: "<div></div>", spinner: "<em>Loading&#8230;</em>"}, _create: function () {
            ...
            if (!this.buttons) {
                ...
                if (c != "") {
                    this.backBtn = a("<li class='previous'><a href='#'>" + c + "</a></li>").appendTo(this.buttons).bind({click: function () {
                            e.back();
                            return false;
                        }}).attr("role", "button");
                    var f = true;
                ...
                if (g != "") {
                    this.nextBtn = a("<li class='next' id='validateButton2' type='submit'><a href='#'>" + g + "</a>").appendTo(this.buttons).bind({click: function () {
                            e.next();
                            return false;
                        }}).attr("role", "button");
                    var f = true;
            ...
            this.panels.each(function () {
                ...
                if (a.data(this, "destroy.bwizard")) {
                    ...
                    a(this).removeClass(["bwizard-activated", "hide"].join(" ")).css({position: "", left: "", top: ""}).removeAttr("aria-hidden");
                }
            });
            ...
            this.xhr = a.ajax(a.extend({}, h.ajaxOptions, {url: d, dataType: "html", success: function (j, i) {
                    a(f).html(j);
                    if (h.cache) {
