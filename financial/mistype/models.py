...
class Mistype(models.Model):
    ...
    enterby = models.ForeignKey(User, default=1, related_name='mistype_enter')
    enterdate = models.DateTimeField(auto_now_add=True)
    modifyby = models.ForeignKey(User, default=1, related_name='mistype_modify')
    ...
    def status_verbose(self):
        return dict(Mistype.STATUS_CHOICES)[self.status]
